...
*/
    ...
    var defaults = {
        ...
        startDateSpanId : 'startDateSpan', // 原来的开始日期Span ID
        startCompareDateId : 'startCompareDate', // 对比开始日期输入框ID
        endDateId : 'endDate', // 结束日期输入框ID
        endDateSpanId : 'endDateSpan', // 原来的结束日期Span ID
...
pickerDateRange.prototype.close = function(btnSubmit) {
	...
	if(btnSubmit){
        ...
        var bDateTimeStr = $('#' + this.startDateId).val();
        var eDateTimeStr = $('#' + this.endDateId).val();
		...
		if(eDateTime < bDateTime){
		 ...
		 var _val = this.mOpts.shortOpr == true ? 
		...
		if(input && input.tagName == 'INPUT'){
            ...
            $('#' + this.mOpts.startDateSpanId).html(bDateTimeStr);
            $('#' + this.mOpts.endDateSpanId).html(eDateTimeStr);
		...
		var _compareVal = this.mOpts.shortOpr == true ? 
            $('#' + this.startCompareDateId).val() : 
            ($('#' + this.startCompareDateId).val() + ('' == $('#' + this.endCompareDateId).val() ? '' : this.mOpts.defaultText + $('#' + this.endCompareDateId).val()));
		if(input && input.tagName == 'INPUT'){
